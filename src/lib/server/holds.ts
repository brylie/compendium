...
//
// WeakMap (not Map) so a destroyed Awareness instance — a shard whose
// connections have all closed — isn't strongly retained for the process
// lifetime just because it once held an agent's clock/timer state.
