...
| **AFFiNE / BlockSuite** | Documents, a freeform “Edgeless” canvas, and databases coexist; Page and Edgeless support divergent thinking versus linear writing. Its recent releases also show ongoing investment in database views, document permissions, imports, and block metadata. | [AFFiNE Team](https://affine.pro/teamhub), [0.27 release](https://affine.pro/blog/whats-new-july-update-2026), [0.21 release](https://affine.pro/blog/whats-new-april-update)                                        | The useful lesson is _mode separation_, not “build a canvas now.” A later visual mode should reuse canonical records and keep edits/audit/agent semantics intact; it must not become a second document system.                                            |
