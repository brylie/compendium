...
- A slash-command menu (typing `/`) inserts or transforms blocks — heading, list, to-do checklist, toggle/collapsible, quote, callout, divider, table, table of contents, synced block, page link, code, embed — following the convention established by Notion, Coda, and WordPress's Gutenberg block inserter.
